var calculate_variables___browser, calculate_variables___for_blue_background, calculate_variables___for_dark_background, move_backgrounds, move_blue_background, move_dark_background, on_mouse_move, on_touch_move, prepare_variables, turn_off_scrolling, turn_on_scrolling;

window.move_background = {};

turn_on_scrolling = function() {
  var header___element;
  prepare_variables();
  header___element = window.move_background.header___element;
  header___element.addEventListener('mousemove', on_mouse_move);
  return header___element.addEventListener('touchmove', on_touch_move);
};

turn_off_scrolling = function() {
  var header___element;
  header___element = window.move_background.header___element;
  header___element.removeEventListener('mousemove', on_mouse_move);
  return header___element.removeEventListener('touchmove', on_touch_move);
};

prepare_variables = function() {
  calculate_variables___browser();
  calculate_variables___for_dark_background();
  return calculate_variables___for_blue_background();
};

calculate_variables___browser = function() {
  var header___element, height_of_screen, screen_center_x, screen_center_y, width_of_screen;
  ...
  screen_center_y = height_of_screen / 2;
  ...
  return window.move_background.screen_center_y = screen_center_y;
};

calculate_variables___for_dark_background = function() {
  var dark_background___amount_of_moving_x, dark_background___amount_of_moving_y, dark_background___element, height_of_background, height_of_screen, width_of_background, width_of_screen;
  ...
  return window.move_background.dark_background___amount_of_moving_y = dark_background___amount_of_moving_y;
};

calculate_variables___for_blue_background = function() {
  var blue_background___amount_of_moving_x, blue_background___amount_of_moving_y, blue_background___element, height_of_background, height_of_screen, moving_from_one_mousemoving___x, moving_from_one_mousemoving___y, width_of_background, width_of_screen;
  width_of_screen = window.move_background.width_of_screen;
  height_of_screen = window.move_background.height_of_screen;
  ...
  return window.move_background.moving_from_one_mousemoving___y = moving_from_one_mousemoving___y;
};
...
on_mouse_move = function(event) {
  ...
  return move_backgrounds(moved_x, moved_y);
};
...
move_backgrounds = function(moved_x, moved_y) {
  window.move_background.moved_x = moved_x;
  window.move_background.moved_y = moved_y;
  move_dark_background();
  return move_blue_background();
};

move_dark_background = function() {
  var amount_moved_x, amount_moved_y, amount_of_transform_x, amount_of_transform_y, dark_background___amount_of_moving_x, dark_background___amount_of_moving_y, dark_background___element, height_of_screen, moved_x, moved_y, moving_from_one_mousemoving___x, moving_from_one_mousemoving___y, screen_center_x, screen_center_y, width_of_screen;
  width_of_screen = window.move_background.width_of_screen;
  height_of_screen = window.move_background.height_of_screen;
  ...
  return dark_background___element.style.transform += ' translateY(' + amount_of_transform_y + "px)";
};

move_blue_background = function() {
  var blue_background___element, cursor_moved_x, cursor_moved_y, height_of_screen, max_moving_x, max_moving_y, moving_from_one_mousemoving___x, moving_from_one_mousemoving___y, screen_center_x, screen_center_y, target_moving_x, target_moving_y, width_of_screen;
  width_of_screen = window.move_background.width_of_screen;
  height_of_screen = window.move_background.height_of_screen;
  screen_center_x = window.move_background.screen_center_x;
  screen_center_y = window.move_background.screen_center_y;
  ...
  return blue_background___element.style.top = -target_moving_y + "px";
};
